...
import config from '../../components/NavBar/NavBarConfig.json';
...
export default function stuNavBar( {changeCurrPage} ) {
  ...
  const menu = (
    <Menu>
        <Menu.Item key='1' onClick={() => changeCurrPage(0)}>
          <i className='fa fa-home' />
          &nbsp; Dashboard
        </Menu.Item>
        <Menu.Item key='2' onClick={() => changeCurrPage(1)}>
          <i className='fa fa-home' />
          &nbsp; Lessons
        </Menu.Item>
        <Menu.Item key='3' onClick={() => changeCurrPage(2)}>
          <i className='fa fa-home' />
          &nbsp; Classroom
        </Menu.Item>
        <Menu.Item key='4' onClick={() => changeCurrPage(3)}>
          <i className='fa fa-home' />
          &nbsp; Parentel
        </Menu.Item>
