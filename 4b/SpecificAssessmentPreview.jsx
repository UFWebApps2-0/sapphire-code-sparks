...
const test = {
  ...
  questions: [
    ...
    },
    {
      ...
      promptImage: "",
      choices: ["FishSticks", "Dogs are Nice", "3", "Owl Fishing"],
      answers: [false, false, true, false],
    },
    {
      type: "multipleChoice",
      ...
      promptImage: "",
      choices: ["FishSticks", "Dogs are Nice", "12  (correct)", "Owl Fishing"],
      answers: [false, false, true, false],
    },
    {
      type: "multipleChoice",
      ...
      promptImage: "",
      choices: ["FishSticks", "Dogs are Nice", "4 (correct)", "Owl Fishing"],
      answers: [false, false, true, false],
    },
  ],
  showGrades: false,
